...
'Error Icon
Public Function Popup_error(Message As String, Title As String)
   With m_IconData
...
'No Icon
Public Function Popup_none(Message As String, Title As String)
   With m_IconData
        .cbSize = Len(m_IconData)
        .hWnd = Form1.hWnd
        .uID = vbNull
...
'Warning Icon
Public Function Popup_warning(Message As String, Title As String)
   With m_IconData
        .cbSize = Len(m_IconData)
        .hWnd = Form1.hWnd
        .uID = vbNull
...
'Info Icon
Public Function Popup_info(Message As String, Title As String)
   With m_IconData
        .cbSize = Len(m_IconData)
        .hWnd = Form1.hWnd
        .uID = vbNull
